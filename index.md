                              ...
                              <div class="modal-body p-0">
                                <div class="card bg-secondary shadow border-0">
                                  <div class="card-body px-lg-5 py-lg-5 homeowner-form-body">
                                    ...
                                    id="homeownerGoogleForm"
                                    role="form"
                                    onsubmit="homeownerFormSubmitted=true;"
                                    method="POST">
                                    ...
                                    <input type="hidden" name="entry.1148005771" id="entry.1148005771" value="Homeowner" >
                                ...
                                <iframe name="hidden_iframe" id="hidden_iframe" style="display:none;" onload="if(homeownerFormSubmitted) {}"></iframe>
                              </div>
                            </div>
                          </div>
                        </div>
